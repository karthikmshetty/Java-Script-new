...
const sortedArrayObject = flightData.sort((a, b) => a.price - b.price);

// Step 3 — print
sortedArrayObject.forEach(f => console.log(`${f.name} : ₹${f.price}`));

//If you want to print specific Index
console.log(" Specific Index ",sortedArrayObject[2]);
